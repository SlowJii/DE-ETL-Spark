...
#WHERE co y nghia la loc cac ban ghi theo dieu kien

# tim cac ban ghi co id cua actor < 20000
#dataFile.where("actor.id < 20000").show()

#dataFile.select(col("id"), col("actor.id").alias("new_actor_id")).filter((col("id") == "2615567732") & (col("actor.id") == 19)).show()
